...
// const indentationSize = atom.config.get('json-sort.indentationSize') || 4;
...
export default {
  ...
  sort() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      ...
      editor.insertText(JSON.stringify(selection, null, atom.config.get('json-sort.indentationSize')));
    }
  }
};
